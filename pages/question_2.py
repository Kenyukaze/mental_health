...
st.markdown('<p class="main-title">Évaluation de la qualité de votre sommeil</p>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">Question 2/7</p>', unsafe_allow_html=True)
...
st.markdown('''<div class="slider-labels">
    <span class="slider-label">2<br><small>Pas du tout</small></span>
    <span class="slider-label">12<br><small>Extrêmement</small></span>
</div>''', unsafe_allow_html=True)

reponse = st.slider("", 2, 12, 7, key="q2", label_visibility="collapsed")
# Normaliser la réponse pour qu'elle soit entre 1 et 10
reponse_normalisee = int(((reponse - 2) / (12 - 2)) * 9) + 1
st.session_state.reponses_df.at[0, "Q2"] = reponse_normalisee

# Enregistrement de la réponse
st.session_state.reponses_df.at[0, "Q2"] = reponse
...
if st.button("Question suivante"):
    st.switch_page("pages/question_3.py")
st.markdown('</div>', unsafe_allow_html=True)
