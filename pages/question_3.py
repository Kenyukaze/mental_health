...
st.markdown('<p class="Question 3 : Comment évaluez vous la qualité du soutien social dont vous disposez ?</p>', unsafe_allow_html=True)
...
if st.button("Question suivante"):
    st.switch_page("pages/question_4.py")
st.markdown('</div>', unsafe_allow_html=True)
