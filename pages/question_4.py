...
st.markdown('<p class="main-title">Évaluation de votre stress sur le plan financier</p>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">Question 4/7</p>', unsafe_allow_html=True)
